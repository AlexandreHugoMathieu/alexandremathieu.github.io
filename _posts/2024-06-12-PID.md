...
Significant potential difference (several hundred volts) between the ground and the cell is the major cause of current leakage and the higher the voltage is, the more the PID degrade the module performances.
