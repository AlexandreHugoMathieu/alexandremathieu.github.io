---
title: 'Potential Induced Degradation (PID): origins, mechanisms, impacts and mitigations'
date: 2024-06-12
...
Significant potential difference (several hundred volts) between the ground and the cell is the major cause of current leakage and the higher the voltage is, the more the PID can degrade the module performances.
...
**Electrical regeneration**, on the other hand, applies reverse voltage to restore the natural composition of the materials. For instance, the IEA report [7] illustrates a 94% regeneration after applying reverse voltage. However, electrical regeneration is never 100% complete due to the original induced corrosion + remaining Sodium (Na) in the "stacking" faults [2].
